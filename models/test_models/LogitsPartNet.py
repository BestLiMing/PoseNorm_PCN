...
class BSATr(nn.Module):
    def __init__(self, block, blocks, num_classes=6, num_parts=14, batchnorm=False):
        super().__init__()
    ...
    def forward(self, points):
        ...
        return {
            ...
            'correspondences': weighted_pred  # torch.Size([1, 3, 10000]
        }


def TPoseNetPart2(**kwargs):
    model = BSATr(PointTransformerBlock, [2, 3, 4, 6, 3], **kwargs)
    return model


if __name__ == "__main__":
    model = TPoseNetPart2(num_classes=3, num_parts=14).cuda()
